    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd layadmin-event="" style="text-align: center;" onclick="logout()"><a>退出</a></dd>
                    </dl>
                </li>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="${ctx}/prod/index" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
...
<script>
    ...
    function logout() {
        layer.confirm('确定退出吗？', function () {
            window.location.href = "${ctx}/securityLogout.do";
        });
        layer.close(index);
    }
</script>
